...
- Added a California-specific positioning section on the homepage (between About and Process): a comparison against DIY / general bookkeeper / general CPA / attorney's paralegal, referencing UFIPA, GC-400/405, and Probate Code sections 16320 to 16375, plus a matching FAQ entry about court-native output format. Sourced from a marketing brief the user got elsewhere.
  - **Deliberately scoped to California only**, labeled "For California Trustees & Attorneys." Aaron's 9 years of experience is California-specific; Wisconsin is a brand-new market for him (he just moved there). Corrected a few spots that previously implied equal CA/WI tenure (team bio, FAQ hero lede, FAQ "what states" answer) so the site doesn't overclaim Wisconsin-specific court-format expertise it doesn't have yet.
  - If/when real Wisconsin experience builds up, consider a parallel Wisconsin-specific comparison section once the state-specific forms/statutes are known well enough to cite with the same confidence.
